...
export default function Index() {
  ...
  const searchQuery = useGithubSearch({ q });
    ...
    <div>
      ...
      <main>
        <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
          ...
          {searchQuery.isError && (
            <div>
              {searchQuery?.error?.response?.message ||
                searchQuery.error?.message}
            </div>
          )}
          {searchQuery.data && (
            <ResultsTable searchQuery={searchQuery} element={(item: any) => (
              <tr
                key={item.id}
              ...
              >
                ...
                <td className="px-6 py-4">{item.isStarred}</td>
              </tr>
            )} />
          )}
